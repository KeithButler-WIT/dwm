...
static const Rule rules[] = {
    ...
    {NULL, NULL, "KeePassXC", 1 << 8, 0, 0, 1, -1},
...
static Key keys[] = {
    ...
    {MODKEY|ShiftMask, XK_s, spawn, SHCMD(TERMINAL " -e discord")},
     ...
     * },
     */
    {MODKEY, XK_n, spawn, SHCMD(TERMINAL " -e emacs ~/org/")},
    ...
    {MODKEY, XK_F12, spawn,
     SHCMD("remaps & notify-send \\\"⌨️ Keyboard remapping...\\\" "
           "\\\"Re-running keyboard defaults for any newly plugged-in "
           "keyboards.\\\"")},
